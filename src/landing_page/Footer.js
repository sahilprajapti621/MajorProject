        ...
        <div className='container border-top mt-5'>
            <div className='row text-muted pt-4'>
                <div className='col'>
                    ...
                    <p className='my-4 fs-6'> &copy; 2010 - 2024, Zerodha Broking Ltd.All rights reserved.</p>
                </div>
                <div className='col'>
